...
/*   Updated: 2024/12/30 13:43:36 by meabdelk         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void to_right(t_map *map)
{
    ...
    y = map->y_p;
    printf("right\n");
    if(x + 1 >= 0 && map->map_copy[y][x + 1] != '1' && map->map_copy[y][x+1] != ' ' && map->map_copy[y][x + 1] != '\t')
    {
...
void to_down(t_map *map)
{
    ...
    y = map->y_p;
    printf("down\n");
    if(y + 1 >= 0 && map->map_copy[y + 1][x] != '1' && map->map_copy[y +1][x] != ' ' && map->map_copy[y +1][x] != '\t')
    {
